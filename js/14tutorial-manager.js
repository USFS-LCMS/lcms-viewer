...
walkThroughDict = {     'intro':{message:`<h5 class = 'list-group-title'>${mode} DATA Explorer Walk-Through</h5>
                        ...
                        'legend':{
                            ...
                            message:`<h5 class = 'list-group-title'>LEGEND</h5>
                                    <ul class="list-group list-group-flush">
                                      <li class="list-group-item">The LEGEND menu in the right sidebar (above this tutorial) shows a key for enabled and visible layers in the ${mode} DATA layers and REFERENCE layers menu in the left sidebar.</li>
                        ...
                        'measuring-tools-distance-measuring':{
                            ...
                            message:`<h5 class = 'list-group-title'>TOOLS-Measuring Tools-Distance Measuring</h5>
                                    <ul class="list-group list-group-flush">
                                      ...
                                      <li class="list-group-item">Once activated, click on the map to draw a line to measure distance. Clicking on the vertex of the drawn line will display the measured distance.</li>
                                      <li class="list-group-item">The midpoint of the line can be moved and adjusted by dragging the faint point in the middle of a drawn line.</li>
                        ...
                        'measuring-tools-area-measuring':{
                            ...
                            message:`<h5 class = 'list-group-title'>TOOLS-Measuring Tools-Area Measuring</h5>
                                    <ul class="list-group list-group-flush">
                                      ...
                                      <li class="list-group-item">Click on map to measure area. Double-click to complete polygon, press <kbd>ctrl+z</kbd> to undo most recent point, press <kbd>Delete</kbd> or <kbd>Backspace</kbd> to start over. The polygon lines can also be adjusted by moving the midpoint of each particular line.</li>
                                      <li class="list-group-item">Buttons are available under the tool in the left sidebar to undo and restart drawing as well.</li>
                                      <li class="list-group-item">Units can be toggled between imperial and metric using the toggle switch.</li>
                                      <li class="list-group-item">If the color of the line is hard to see, it can be changed with the color picker paintbrush under the tool in the left sidebar.</li>
                        ...
                        "area-tools-user-selected-area":{
                            ...
                            message:`<h5 class = 'list-group-title'>TOOLS-Area Tools-Select an Area on Map</h5>
                                    <ul class="list-group list-group-flush">
                                      ...
                                      <li class="list-group-item">This tool allows you to summarize ${mode} products across a selection of pre-defined areas.</li>
                                      ...
                                      <li class="list-group-item">You can change the name of the chart if you would like in the "Name your charting area!" input box.</li>
                        ...
                        'parameters-mtbs':{
                            ...
                            message:`<h5 class = 'list-group-title'>PARAMETERS</h5>
                                    <ul class="list-group list-group-flush">
                                      <li class="list-group-item">There are a number of parameters that can be changed to enhance the utility of MTBS Data.</li>
                                      <li class="list-group-item">The first is a set of radio buttons that enable zooming to different areas where ${mode} products are available. Click on any area to zoom to it's extent.</li>
