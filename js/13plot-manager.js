...
var hiFinal = {name:'HI',path:'./geojson/HI_plots_1000_selected_v2_g_albers_30m_box.json','plotIDField':'PLOTID'}
var plotsGeoJSONs =[hiFinal];//[r4PlotsJson,lcmap,conus1];//,mls,bt,fnf];
