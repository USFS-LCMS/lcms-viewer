...
if(mode==='lcms-dashboard' || mode === 'Bloom-Mapper' || mode === 'TreeMap' || mode === 'sequoia-view'){
  ...
  ['Advanced Parameters',`Several parameters are available to change to help with change detection and data visualization. These parameters are retained in the unique link that is created when you click the <i class="fa fa-share-alt teal "></i> icon above.`,'#advanced-params-label','right',[0,2],'advanced-params-tour-modal','#advanced-params-label>h5'],
