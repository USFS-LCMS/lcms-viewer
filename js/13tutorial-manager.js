...
['What Units',`Choose to show areas as proportions of the entire summary area or in acres or hectares. When this is changed, all charts and tables are automatically updated`,'#which-units-radio','right-end',[0,2],'annual-change-method-tour-modal','#parameters-collapse-label-label'],
...
['Which LCMS Products',`Choose which LCMS products to show. You can choose more than one product. If you are interested in monitoring changes in cover, choose Land Cover. If you are interested in changes related to how land is being used, choose Land Use.`,'#which-products-radio','right-end',[0,2],'which-lcms-product-tour-modal','#parameters-collapse-label-label'],
