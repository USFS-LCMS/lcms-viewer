...
if(mode === 'LCMS-pilot' || mode === 'MTBS'|| mode === 'lcms-base-learner' || mode === 'FHP' || mode === 'LCMS'){
  ...
  addRangeSlider('simplify-error-range-container','Simplify Area - Max Error','simplifyMaxError',0, 500, 0 , 50,'simplify-error-slider','null',"If the selected area is very large and/or has a lot of vertices, it may not compute. In this instance, clear out any existing selections (trash can button), and increase this value. The selected polygon will be simplified using a max error in meters equal to this value upon selection. Generally between 50 and 150 will get most areas to work.")
