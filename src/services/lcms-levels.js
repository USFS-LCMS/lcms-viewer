function levelSymbology() {
  ...
  this.newDefaultProductLevelLookups = {
    ...
    Change: {
      ...
      "2.1.2.1": [4, "D54309", "Fire"],
      "2.1.2.2": [5, "D55555", "Tree Removal"],
      "2.1.2.3": [1, "D5ACAC", "Wind"],
      "2.1.2.4": [2, "2C58A9", "Water Inundation"],
      "2.1.2.5": [3, "D5C33C", "Water Desiccation"],
