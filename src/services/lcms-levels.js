function levelSymbology() {
  ...
  this.newDefaultProductLevelLookups = {
    ...
    Change: {
      ...
      "1.1.1.1": [1, "D5ACAC", "Wind"],
      "1.1.1.2": [2, "2C58A9", "Water Inundation"],
      "1.1.1.3": [3, "D5C33C", "Water Desiccation"],
      ...
      "1.1.1.1.2": [2, "D54599", "Tornado or Wind"],
      "1.1.1.2.1": [3, "2C58A9", "Water Inundation"],
      "1.1.1.3.1": [4, "D5C33C", "Water Desiccation"],
      "1.1.1.4.1": [5, "D54309", "Wildfire"],
      "1.1.1.4.2": [6, "FFCCB4", "Prescribed Fire"],
      "1.1.1.5.1": [7, "D55555", "Tree Removal"],
      "1.1.1.6.1": [8, "D5C08B", "Mechanical Land Transformation"],
      "1.1.1.7.1": [9, "C291D5", "Other Vegetation Loss"],

      "1.1.2.1.1": [10, "F39268", "Insect, Disease or Drought Stress"],
      "1.1.2.1.2": [11, "F3C165", "Defolation or Southern Pine Beetle"],
      "2.1.1.1.1": [12, "00A398", "Vegetation Growth"],
      "2.2.1.1.1": [13, "3D4551", "Stable"],
