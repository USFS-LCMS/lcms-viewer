    ...
    this.products.map((k) => {
      ...
      Object.keys(urlParams.productLevelLookups[k]).map((k2) => {
        ...
        $(`#${k}-color-list`).append(`<tr ${rowStyle}>
          ...
          <td>
          <input  class = 'class-color-pickers' id="${tempKey}" data-jscolor="{backgroundColor:'#372e2c',value:'#${l[1]}'}">
...
levelObj.setupUI();
// console.log(urlParams.productLevelLookups);
